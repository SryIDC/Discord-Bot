  ...
  async execute(interaction) {
    ...
    switch (splitArray[1]) {
      case "Kick":
        {
          member
            .kick(`Kicked by: ${interaction.user.tag} | Member Logging Ststem`)
            .then(() => {
              interaction
                .reply({
      ...
      case "Ban":
        {
          member
            .ban(`Banned by: ${interaction.user.tag} | Member Logging Ststem`)
            .then(() => {
              interaction
                .reply({
                ...
                .catch(() => {
                  interaction.reply({
                    embeds: [
                      Embed.setDescription(`${member} cannot be banned.`),
                    ],
                  });
                });
            });
