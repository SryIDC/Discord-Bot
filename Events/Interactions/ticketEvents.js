    ...
    if (interaction.isButton) {
      ...
      switch (customId) {
        ...
        case "closereq":
          ...
          if (!member.roles.cache.find((r) => r.id === ticketData.supportId)) {
            return await interaction.reply({
              embeds: [
                new EmbedBuilder()
                  .setColor("Red")
          ...
          if (userData.closed === true)
            return await interaction.reply({
              embeds: [
                new EmbedBuilder()
                  .setDescription("The ticket has already been closed🔒")
                  .setColor("0x2F3136"),
              ],
            });
          ...
          const closereq = new EmbedBuilder()
            ...
            .addFields(
              {
                name: "Ticket Creator",
                value: `<@${userData.creatorId}> created this ticket.`,
              },
              {
                name: "Requested at 🕐",
                value: `${new Date().toLocaleString()}`,
            ...
            .setFooter({
              text: `${client.user.tag}, Requested to close by ${member.user.id}🙋‍♂️`,
              iconURL: client.user.displayAvatarURL(),
            });
